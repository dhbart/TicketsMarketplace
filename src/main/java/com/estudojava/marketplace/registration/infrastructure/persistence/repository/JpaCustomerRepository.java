package com.estudojava.marketplace.registration.infrastructure.persistence.repository;

import com.estudojava.marketplace.common.infrastructure.event.dto.CustomerCreated;
import com.estudojava.marketplace.registration.domain.Customer;
import com.estudojava.marketplace.registration.domain.CustomerId;
import com.estudojava.marketplace.registration.domain.CustomerRepository;
...
public class JpaCustomerRepository implements CustomerRepository {
    ...
    private static com.estudojava.marketplace.registration.infrastructure.persistence.entity.Customer mapper(Customer customer) {
        var entity = new com.estudojava.marketplace.registration.infrastructure.persistence.entity.Customer();
    ...
    private static Customer mapper(com.estudojava.marketplace.registration.infrastructure.persistence.entity.Customer entity) {
