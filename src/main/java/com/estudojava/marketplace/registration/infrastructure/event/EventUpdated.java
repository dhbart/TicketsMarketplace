...
import com.estudojava.marketplace.catalog.infrastructure.persistence.entity.EventMetadata;
...
public record EventUpdated(String id, List<Sector> sectors) {
    ...
    public record Sector(String id, BigDecimal price, List<Seat> seats) {
        ...
        public static Sector from(
                EventMetadata.Sector sector,
                List<EventMetadata.Seat> allSeats) {
