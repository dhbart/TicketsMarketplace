package com.estudojava.marketplace.registration.infrastructure;
...
@EnableJpaRepositories(
        basePackages = "com.estudojava.marketplace.registration",
...
public class RegistrationConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean registrationEntityManagerFactory(
        ...
        return builder
                .dataSource(dataSource)
                .packages("com.estudojava.marketplace.registration")
